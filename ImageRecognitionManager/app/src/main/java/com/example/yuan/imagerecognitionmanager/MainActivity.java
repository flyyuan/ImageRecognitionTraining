...
public class MainActivity extends AppCompatActivity  implements ExecutorWithListener.OnAllTaskEndListener {
    private static final String URL_base = "http://39.108.69.214:8080/xxzx/a/tpsb/";
    ...
    private static final String URL_exit = "http://39.108.69.214:8080/xxzx/a/logout";
    ...
    int SuccessNum = 0;
    private String[] items = new String[]{"中文","English"};
...
//        //在SP中获取sessionid
        ...
        languageItem = prefs.getInt("languageItem",0);
...
//        uploadManager.getThreadPool().getExecutor().removeOnAllTaskEndListener(this);
    ...
    public void setLanguage(View view){
        dialog = new AlertDialog.Builder(this).setSingleChoiceItems(items,languageItem, new DialogInterface.OnClickListener() {
            @Override
    ...
    protected void switchLanguage(String language){
        ...
        editor.putInt("languageItem",languageItem);
        editor.apply();
    }
