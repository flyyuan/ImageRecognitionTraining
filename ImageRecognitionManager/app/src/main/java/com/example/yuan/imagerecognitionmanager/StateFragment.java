...
public class StateFragment extends Fragment {
    ...
    private static final String URL_userManage = "http://39.108.69.214:8080/xxzx/a/tpsb/userManage/getAllUserTagResult";
    private static final String URL_deleteByMobile = "http://39.108.69.214:8080/xxzx/a/sys/user/deleteByMobile";
    private String URL_setPermissions = "http://39.108.69.214:8080/xxzx/a/tpsb/userManage/setPermissions";
...
//                ,LinearLayoutManager.VERTICAL));// 添加分割线。
    ...
    private void setToolbar(){
        toolbar.setTitle(this.getResources().getString(R.string.title_state));
    }
...
//            swipeLeftMenu.setOrientation(SwipeMenu.VERTICAL);
            ...
            // 添加左侧的，如果不添加，则左侧不会出现菜单。
            {
                SwipeMenuItem NormalItem = new SwipeMenuItem(getActivity())
                        ...
                        .setText(StateFragment.this.getResources().getString(R.string.normal))
                ...
                SwipeMenuItem forbidSelect = new SwipeMenuItem(getActivity())
                        ...
                        .setText(StateFragment.this.getResources().getString(R.string.First_choice))
                        .setTextColor(Color.WHITE)
                        .setWidth(width) // 宽度。
                        .setHeight(height); // 高度。
                ...
                SwipeMenuItem forbidWrite = new SwipeMenuItem(getActivity())
                        ...
                        .setText(StateFragment.this.getResources().getString(R.string.Fill_in_first))
                        .setTextColor(Color.WHITE)
                        .setWidth(width)
                        .setHeight(height);
            ...
            // 添加右侧的，如果不添加，则右侧不会出现菜单。
            {
                SwipeMenuItem deleteItem = new SwipeMenuItem(getActivity())
                        ...
                        .setText(StateFragment.this.getResources().getString(R.string.delete)) // 文字，还可以设置文字颜色，大小等。。
                        .setTextColor(Color.WHITE)
                        .setWidth(width)
                        .setHeight(height);
                ...
                SwipeMenuItem closeSelect = new SwipeMenuItem(getActivity())
                        ...
                        .setText(StateFragment.this.getResources().getString(R.string.forbid_choice))
                        .setTextColor(Color.WHITE)
                        .setWidth(width)
                        .setHeight(height);
                ...
                SwipeMenuItem closeWrite = new SwipeMenuItem(getActivity())
                        ...
                        .setText(StateFragment.this.getResources().getString(R.string.No_fill_in))
                        .setTextColor(Color.WHITE)
                        .setWidth(width)
                        .setHeight(height);
                ...
                SwipeMenuItem closeWriteAndSelect = new SwipeMenuItem(getActivity())
                        ...
                        .setText(StateFragment.this.getResources().getString(R.string.forbid_choice_fill))
                        .setTextColor(Color.WHITE)
                        .setWidth(width)
                        .setHeight(height);
