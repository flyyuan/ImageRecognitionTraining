...
public class PresonalFragment extends Fragment {
    ...
    private void setToolbar(){
        toolbar.setTitle(this.getResources().getString(R.string.title_me));
    }
    private void setPresonal() {
        ...
        Log.d("--------->",name);
        Log.d("--------->",loginName);
        name_tv.setText(this.getResources().getString(R.string.name)+name);
        input_name.setText(this.getResources().getString(R.string.login_name)+loginName);
    }
